...
1) [cpplex](https://code.google.com/archive/p/cpplex/). We made changes to be a header-only library. We tested and rejected because it is inefficient for our project.  
...
4) [lpsolver](http://lpsolve.sourceforge.net/5.5/Build.htm). We are trying to implement a dynamic or a static call.
