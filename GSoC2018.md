...
*CGAL exclusion completed.* We created a new Cartesian Kernela and a new Point class. We consider points as vectors starting at the origin. So we define the following operators: +, - , (double)*(point).

* ##### *2nd week* 
Working on Boost exclusion and adding a new c++ LP solver...
