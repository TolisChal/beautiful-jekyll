...
4) Complete schedule_annealing for gaussian distribution in schedule_annealing branch in the gaussian_annealing.h header file. We follow the [paper](http://mpc.zib.de/index.php/MPC/article/view/178) of Cousins and Vempala ans the [matlab code](https://www.mathworks.com/matlabcentral/fileexchange/43596-volume-computation-of-convex-bodies).  
...
5) Create better test mechanism.
