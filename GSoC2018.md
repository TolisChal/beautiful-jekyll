...
2) Furthermore we have completed all 5th week's work, by replacing the Boost library and completing the Rcpp interface. We have completed 6th week's work except V-polytope class by implementing the classes for the non-linear bodies of the Part II of the project.
