...
In test file we develop the pure C++ code of the project, using a C++ main function.  
In folder R-proj/src we develop the R interface.  

We have to work more on the R interface and on general C++ code development. The next step is to add a LP solver.
